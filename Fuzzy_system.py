...
def run_fuzzy_system(tightness, aggressiveness, money_opponent, money_player, probability_hand ):
	...
	optimal, risk0, aggregated = fuzzy_inference(Strategy, quality_cards_opponent, odds_player, strategy_members, "strategy")
...
money_player= 0.8
probability = 0.9
optimal = run_fuzzy_system(tight, aggressive, money_opponent, money_player, probability)
